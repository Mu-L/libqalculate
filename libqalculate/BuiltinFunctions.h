...
DECLARE_BUILTIN_FUNCTION(CircShiftFunction, FUNCTION_ID_CIRCSHIFT)
DECLARE_BUILTIN_FUNCTION(ReshapeFunction, FUNCTION_ID_RESHAPE)
...
DECLARE_BUILTIN_FUNCTION(ReplacePartFunction, FUNCTION_ID_REPLACE_PART)
...
DECLARE_BUILTIN_FUNCTION(FindFunction, FUNCTION_ID_FIND)
...
DECLARE_BUILTIN_FUNCTION(UnionFunction, FUNCTION_ID_UNION)
DECLARE_BUILTIN_FUNCTION(IntersectFunction, FUNCTION_ID_INTERSECT)
DECLARE_BUILTIN_FUNCTION(SetDifferenceFunction, FUNCTION_ID_SET_DIFFERENCE)
DECLARE_BUILTIN_FUNCTION(IsMemberFunction, FUNCTION_ID_IS_MEMBER)
DECLARE_BUILTIN_FUNCTION(IsSubsetFunction, FUNCTION_ID_IS_SUBSET)
DECLARE_BUILTIN_FUNCTION(UniqueFunction, FUNCTION_ID_UNIQUE)
DECLARE_BUILTIN_FUNCTION(CountFunction, FUNCTION_ID_COUNT)
...
DECLARE_BUILTIN_FUNCTION(PopCountFunction, FUNCTION_ID_POP_COUNT)
...
DECLARE_BUILTIN_FUNCTION(YMDFunction, FUNCTION_ID_YMD)
...
DECLARE_BUILTIN_FUNCTION(AsciiFunction, FUNCTION_ID_ASCII)
...
DECLARE_BUILTIN_FUNCTION(StringFunction, FUNCTION_ID_STRING)
DECLARE_BUILTIN_FUNCTION(CharactersFunction, FUNCTION_ID_CHARACTERS)
...
DECLARE_BUILTIN_FUNCTION(LaTeXFunction, FUNCTION_ID_LATEX)
