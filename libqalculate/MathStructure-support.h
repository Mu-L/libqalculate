...
void replace_fracpow(MathStructure &mstruct, std::vector<UnknownVariable*> &uv, MathStructure *top_mstruct = NULL);
bool restore_fracpow(MathStructure &mstruct, UnknownVariable *uv, const EvaluationOptions &eo, bool b_eval);
bool test_replace_fracpow(const MathStructure &mstruct, bool two = false, bool top = true);
